...
-- TriNetra AI Phase 2 → Phase 3 Schema Baseline
--
-- This migration ports the manual schema_extensions.sql into Flyway version
-- control. Run ONCE on a fresh database (or with baseline-on-migrate=true
-- if Phase 2 tables already exist).
--
-- Checksum: stable (do not edit after deployment)
