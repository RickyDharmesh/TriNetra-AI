              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <span className="font-mono text-xs font-bold text-indigo-400">{claim.claimId}</span>
                  ...
                  <div className="flex items-center space-x-3 text-xs text-slate-300">
                    <span className="font-semibold text-white">{claim.product || 'Smartphone'}</span>
                    <span className="text-slate-500">•</span>
                    <span className="text-slate-400">{claim.state || claim.status}</span>
                  </div>
                </div>

                <div className="flex items-center space-x-4">
                  <div className="text-right">
                    {getVerdictBadge(claim.state)}
                    <div className="mt-1 text-[11px] text-slate-400 font-mono">
                      {claim.outboundWeightGrams ?? 0}g → {claim.returnWeightGrams ?? 0}g
                    </div>
                  </div>
